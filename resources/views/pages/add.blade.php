...
<div class="container">
  <h2>Pages Form</h2>
  <form action="{{route('pages.save-add')}}" method="POST"  enctype="multipart/form-data" id="pages">
    ...
    <div class="form-group">
      ...
      <input type="url" class="form-control" placeholder="Enter url"  id="url"  name="url">
    </div>
    ...
    <div class="form-group">
      ...
      <textarea  class="form-control" id="shortdescription" placeholder="Enter description" name="shortdescription"></textarea>
    </div>

    <div class="form-group">
      <label >Long Description:</label>
      <textarea  class="form-control" id="longdescription" placeholder="Enter description" name="longdescription"></textarea>
    </div>
