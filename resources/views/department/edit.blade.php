...
<div class="container">
  ...
  <form action="{{route('department.save-edit',$geteditdata->id)}}" method="POST"  enctype="multipart/form-data" id="department">
    ...
    @csrf
     ...
     <div class="form-group">
      <label >Image:</label>
      <input type="file" class="form-control" value="{{$geteditdata->image}}" id="image"  name="image">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="{{$geteditdata->small_description}}"  id="smalldescription" placeholder="Enter small description" name="smalldescription">
    </div>
