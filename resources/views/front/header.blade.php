              ...
              <div class="collapse navbar-collapse" id="navbarmain">
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item active">
                   ...
                   <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="b{{route('front.blog-sidebar')}}log-sidebar.html" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog <i class="icofont-thin-down"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown05">
                            <li><a class="dropdown-item" href="{{route('front.blog-sidebar')}}">Blog with Sidebar</a></li>

                            <li><a class="dropdown-item" href="{{route('front.blog-single')}}">Blog Single</a></li>
                        </ul>
                      </li>
