        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    @if (isset($getblogs) && !$getblogs->isEmpty())

                    @foreach ($getblogs as $key=>$v)

                    <div class="col-lg-12 col-md-12 mb-5">
                        <div class="blog-item">
                            <div class="blog-thumb">
                                <img src="{{asset('uploads/blog/'.$v->image)}}" alt="" class="img-fluid ">
                            </div>
                            ...
                            <div class="blog-item-content">
                                ...
                                <h2 class="mt-3 mb-3"><a href="blog-single.html">{{$v->title}}</a></h2>

                                <p class="mb-4">{{$v->description}}.</p>

                                <a href="{{route('front.blog-singlepage',$v->id)}}" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
                            </div>
                        </div>
                    </div>
